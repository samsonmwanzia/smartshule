<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 ">
                <form method="get" action="{{ route('school.examination.marks') }}" class="">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3">
                            <label for="class_id"><strong>Subject</strong></label>
                            <select id="subject_id" name="subject_id" class="form-select @error('subject_id') is-invalid @enderror">
