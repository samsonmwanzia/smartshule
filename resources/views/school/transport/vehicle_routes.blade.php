        ...
        <div class="row">
            <div class="col-5">
                <div class="card mb-5 rounded-0">
                    <div class="card-body">
                        <h4>Add vehicle route</h4>
                        <form method="post" action="{{ route('school.transport.vehicle_route.post') }}">
                            @csrf
                            <div class="mb-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-switch ms-auto">
                                                    <input type="checkbox" class="form-check-input" @if($route->is_active = true) checked="" @endif   value="0">
                                                </div>
                                            </td>
                                            <td>
