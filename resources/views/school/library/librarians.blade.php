...
@section('content')
    <div id="content" class="app-content">
        <div class="row">
            <div class="col-xl-12">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">LIBRARIANS INFORMATION</a></li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-5">
                <div class="card mb-5 rounded-0">
                    <div class="card-body">
                        <h4>Add librarian</h4>
                        <form method="post" action="{{ route('school.library.librarians.post') }}">
                            @csrf
                            <div class="mb-3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch ms-auto">
                                                        <input type="checkbox" class="form-check-input" @if($librarian->is_active = true) checked="" @endif   value="0">
                                                    </div>
                                                </td>
                                                <td>
