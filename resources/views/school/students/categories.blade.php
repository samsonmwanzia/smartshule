...
@section('content')
    <div id="content" class="app-content">
        <div class="row">
            <div class="col-xl-12">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">STUDENT CATEGORIES</a></li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-5">
                <div class="card mb-5">
                    <div class="card-body">
                        <h4>Add Student Category</h4>
                        <form method="post" action="{{ route('school.post.student.category') }}">
                            @csrf
                            <div class="mb-3">
